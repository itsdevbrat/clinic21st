...
const UserForm = props => {
    ...
    const [verticalsClicked, setVerticalsClicked] = useState(new Array(verticals.length).fill(true))

    const addVertical = (vertical) => setVerticalsSelected(verticalsSelected.push(vertical))

    const removeVertical = (vertical) => setVerticalsSelected(verticalsSelected.filter(verticalSelected => verticalSelected !== vertical))
