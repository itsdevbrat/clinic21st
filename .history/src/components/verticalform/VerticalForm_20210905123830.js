...
const VerticalForm = props => {
    ...
    return (
        <form className="dashboard-form verticalForm" onSubmit={formik.handleSubmit}>
            <TextField name="verticalName" type="text" placeholder="Vertical Name" margin='dense' var
            ...
            <br />
            <TextField name="driveLink" type="text" placeholder="Google drive folder link" margin='dense'
