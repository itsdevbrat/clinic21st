...
const VerticalForm = props => {
    ...
    return (
        <form className="dashboard-form verticalForm" onSubmit={formik.handleSubmit}>
            <Text name="verticalName" type="text" placeholder="Vertical Name" margin='dense'
            ...
            <br />
            <Text name="driveLink" type="text" placeholder="Google drive folder link" margin='dense'
